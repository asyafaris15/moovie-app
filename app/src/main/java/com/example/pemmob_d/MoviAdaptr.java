...
public class MoviAdaptr extends RecyclerView.Adapter<MoviAdaptr.MyViewHolder> {
    ...
    public MoviAdaptr(List<NoteMovi> listMovi, Context activity) {
    ...
    @NonNull
    @Override
    public MoviAdaptr.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_movi,parent, false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull MoviAdaptr.MyViewHolder holder, int position) {
        ...
        holder.moviLayout.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(context, DetailMovi.class);
...
//            activity.startActivity(intent);
    ...
    public void setOnItemClickListener(MoviAdaptr.ClickListener clickListener) {
        MoviAdaptr.clickListener = clickListener;
    }
