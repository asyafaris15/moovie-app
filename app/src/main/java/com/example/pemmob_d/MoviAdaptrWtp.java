...
public class MoviAdaptrWtp extends RecyclerView.Adapter<MoviAdaptrWtp.MyViewHolder> {
    ...
    public MoviAdaptrWtp(List<NoteMovi> listMovi, Context activity) {
    ...
    @NonNull
    @Override
    public MoviAdaptrWtp.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_movi,parent, false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull MoviAdaptrWtp.MyViewHolder holder, int position) {
        ...
        holder.moviLayout.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(context, DetailMovi_wtp.class);
...
//            activity.startActivity(intent);
    ...
    public void setOnItemClickListener(MoviAdaptrWtp.ClickListener clickListener) {
        MoviAdaptrWtp.clickListener = clickListener;
    }
