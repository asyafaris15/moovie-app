...
public class ListMovi_Wtp extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        set_user.setOnClickListener(v -> {
            Intent intent = new Intent(ListMovi_Wtp.this, UserData.class);
            startActivity(intent);
        });

        favorit.setOnClickListener(v -> {
            Intent intent = new Intent(ListMovi_Wtp.this, ListMovi_favorit.class);
            startActivity(intent);
        });

        semua_list.setOnClickListener(view -> {
            Intent intent = new Intent(ListMovi_Wtp.this, ListMovi.class);
            startActivity(intent);
        });
    }
    ...
    protected void onStart() {
        ...
        if (semua_list.getText().toString().equals("wtp")) {
        ...
        childEventListener = databaseReference.child("Status").addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                ...
                if (note != null && note.getUser_id() != null && note.getMovi_status() != null) {
                    if (note.getUser_id().equals(users) && note.getMovi_status().equals("Watch to Plan")) {
